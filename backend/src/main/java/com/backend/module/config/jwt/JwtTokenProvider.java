...
public class JwtTokenProvider {
    ...
    @Value("${jwt.accessTokenMinute}")
    private long accessTokenMinute;

    @Value("${jwt.refreshTokenDay}")
    ...
    public UserResponseDto.TokenInfo generateToken(Authentication authentication) {
        ...
        String refreshToken = Jwts.builder()
                .setExpiration(new Date(now + (REFRESH_TOKEN_EXPIRE_TIME * refreshTokenDay)))
                .signWith(key, SignatureAlgorithm.HS256)
                .compact();
        ...
        return UserResponseDto.TokenInfo.builder()
                              ...
                              .refreshTokenExpirationTime((REFRESH_TOKEN_EXPIRE_TIME * refreshTokenDay))
                              .build();
    }
